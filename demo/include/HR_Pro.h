 ...
 *	@param nDirection : 需要运动的关节运动方向：0(负方向)/1(正方向)
 *	
 *	@return : nRet=0 : 返回函数调用成功
 *            nRet>0 : 返回调用失败的错误码
 */
 ...
 *	@param nDirection : 指定运动的关节方向：0(负方向)/1(正方向)
 *	@param nState : 0(关闭)/1(开启)
 *	
 *	@return : nRet=0 : 返回函数调用成功
 *            nRet>0 : 返回调用失败的错误码
 ...
 *	@param nDirection : 指定运动的迪卡尔坐标方向：0(负方向)/1(正方向)
 *	@param nState : 0(关闭)/1(开启)
 *	
 *	@return : nRet=0 : 返回函数调用成功
 *            nRet>0 : 返回调用失败的错误码
 ...
 *	@param boxID : 电箱ID号，默认值=0
 *	@param rbtID : 机器人ID号，默认值=0
 *	@param dMaxLineVel: 位置跟随直线最大跟随速度，单位[mm/s]
 *	@param dMaxOriVel: 位置跟随姿态最大跟随速度，单位[°/s]
 *	
 *	@return : nRet=0 : 返回函数调用成功
 *            nRet>0 : 返回调用失败的错误码
 */	
 ...
 *	@param boxID : 电箱ID号，默认值=0
 *	@param rbtID : 机器人ID号，默认值=0
 *	@param dPosPID1-dPosPID3: 位置跟随PID
 *	@param dOriPID1-dOriPID3: 姿态跟随PID
 *	
 *	@return : nRet=0 : 返回函数调用成功
 *            nRet>0 : 返回调用失败的错误码
 */	
